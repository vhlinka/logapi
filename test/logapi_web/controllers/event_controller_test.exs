defmodule LogApiWeb.EventControllerTest do
  use LogApiWeb.ConnCase

  alias LogApi.Shipment
  alias LogApi.Shipment.Event

  @create_attrs %{eventlog: "some eventlog", pkgname: "some pkgname", ship_dte: ~D[2010-04-17]}
  ...
  def fixture(:event) do
    {:ok, event} = Shipment.create_event(@create_attrs)
    event
  end
  ...
  describe "update event" do
    ...
    test "renders event when data is valid", %{conn: conn, event: %Event{id: id} = event} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "eventlog" => "some updated eventlog",
        "pkgname" => "some updated pkgname",
        "ship_dte" => "2011-05-18"}
    end
